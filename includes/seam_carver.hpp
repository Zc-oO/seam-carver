...
public:
  ...
  void VerticalSeamArray(int** input) const;

  void HorizontalSeamArray(int** input) const;

  void CalculateVertSeam(int** input, int* seam) const;

  void CalculateHoriSeam(int** input, int* seam) const;
